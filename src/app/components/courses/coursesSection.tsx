...
import StyledCard from "./courses";
const colors = {
  neutralLight: "#F5EAE0",
  darkerGray: "#5C5C5C",
  gradientPink: "linear-gradient(45deg, #FFB6C1, #FF69B4)",
  gold: "#FFD700",
  backgroundImage: "url('/aaa.webp')",
...
const CoursesIntroContainer = styled.div`
  ...
  @media (max-width: 1300px) {
    background-image: url("/aa.webp"); // Imagen diferente para móviles
  }
`;
    ...
    <>
      <CoursesIntroContainer>
        ...
        <CoursesSection style={containerStyles}>
          <StyledCard
            courseId="1"
            $imageUrl="/curso/cursos-de-maquillaje-aprende-2ImagenUrl.webp"
            bgUrl="/curso/abstract-pink-background-pink-modern-shapes-background-vectorBgUrl.webp"
            cutUrl="/curso/cursos-de-maquillaje-aprende-2-removebg.png"
