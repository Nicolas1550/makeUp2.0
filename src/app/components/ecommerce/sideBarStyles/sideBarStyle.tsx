...
export const StickyFilterContainer = styled(StickyFilterContainerBase)`
  ...
  @media (max-width: 768px) {
    ...
    top: 50px; // Colocar el contenedor justo debajo del botón hamburguesa
    left: 0;
    right: 0;
    width: 100%;
...
export const HamburgerButton = styled.button`
  ...
  background-color: #333; // Color principal del botón
  color: white;
  border: none;
  cursor: pointer;
  z-index: 1000; // Asegura que esté siempre encima del contenido
  position: fixed; // Fijo para evitar que se mueva con el contenido
  top: 0; // Siempre en la parte superior
  left: 0; // Asegura que se mantenga en la parte izquierda
  width: 100%; // Ocupar todo el ancho de la pantalla
  height: 50px; // Altura fija para evitar que cambie con el sidebar
  padding: 10px 0; // Espaciado vertical
  text-align: center; // Centrar el texto
  border-radius: 0; // Sin bordes redondeados
  box-shadow: 0px 3px 15px rgba(0, 0, 0, 0.2); // Sombra
